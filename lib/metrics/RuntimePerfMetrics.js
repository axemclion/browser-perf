...
var StatData = require('./util/StatData'),
	TimelineMetrics = require('./TimelineMetrics'),
	helpers = require('../helpers');

function RuntimePerfMetrics() {
	TimelineMetrics.apply(this, arguments);
...
require('util').inherits(RuntimePerfMetrics, TimelineMetrics);

RuntimePerfMetrics.prototype.id = 'RuntimePerfMetrics';

RuntimePerfMetrics.prototype.processRecord_ = function(record) {
