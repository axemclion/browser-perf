var log = function() {
	if (typeof global.logger === 'undefined') {
		setLogger(console.log.bind(console), true);
	}
	return global.logger;
};

var setLogger = function(l, canOverwrite) {
	if (typeof global.logger !== 'undefined' && !canOverwrite) {
		return;
	}
	...
	//TODO: Need a better way to set loggers globally
	global.logger = l;
}
