...
RafBenchmarkingProbe.prototype.start = function(cfg, browser) {
	var code = function() {
...
RafBenchmarkingProbe.prototype.teardown = function(cfg, browser) {
	log.debug('[RafBenchmarkingProbe]: Clearing timer Interval');
	var me = this;
