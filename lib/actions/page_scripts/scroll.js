...
(function() {
  ...
  ScrollAction.prototype.getRemainingScrollDistance_ = function() {
    ...
    console.log(this.scrollHeight_ - this.element_.scrollTop - clientHeight)
  ...
  ScrollAction.prototype.onGestureComplete_ = function() {
    ...
    // AXE - Seems Arbitrary, but with Chrome 35, scroll distance of 2 is always set
    // Need to investigate into this better, but this temp fix seems to work
    if (this.getRemainingScrollDistance_() > 2) {
      this.gesture_.start(this.getRemainingScrollDistance_(),
                          this.onGestureComplete_.bind(this));
      return;
    }
