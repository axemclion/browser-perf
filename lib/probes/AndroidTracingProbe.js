...
AndroidTracingProbe.prototype.startRecordingTrace_ = function(browser) {
	...
	return this.run_('adb shell \'am broadcast -a com.android.chrome.GPU_PROFILER_START -e continuous "" -e categories "benchmark,disabled-by-default-devtools.timeline,toplevel,disabled-by-default-devtools.timeline.frame"\'').then(function() {
