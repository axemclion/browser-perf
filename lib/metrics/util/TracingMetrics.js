...
TracingMetric.prototype.addData = function(results) {
	...
	results['mean_frame_time'] = helpers.metrics(mean_frame_time, 'RenderingMetrics', 'ms', 5);


	// Absolute discrepancy of frame time stamps.
	var jank = statistics.FrameDiscrepancy(self._stats.frame_timestamps);
	results['jank'] = helpers.metrics(jank, 'RenderingMetrics', 'ms', 5);
	...
	results['mostly_smooth'] = helpers.metrics(percentile, 'RenderingMetrics', 'percentile', 5);
